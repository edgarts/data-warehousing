...
-- then left joins to taxi+_zone_lookup on pickup location id, this avoids losing trips,
-- then also left joins to taxi+_zone_lookup on dropoff location id, this also avoids losing trips,
